    ...
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                My favorite recipe: Tiramisu
                <ol id="wd-your-favorite-recipe">
                    <li>Whip egg yolks and ¼ cup sugar until pale yellow and
                        tripled in volume, then set aside
                    </li>
                    <li>Whip cream and remaining ¼ cup sugar to soft peaks, add
                        mascarpone, and whip to a spreadable
                        consistency, then fold into the egg yolk mixture.
                    </li>
                    <li>Combine espresso and rum in a shallow bowl.</li>
                    <li>Dust the bottom of a baking dish with 1 tablespoon of
                        cocoa powder.
                    </li>
                    <li>Quickly dip each ladyfinger in the espresso mixture and
                        layer half in the
                        dish, then spread half the mascarpone mixture on top.
                    </li>
                    <li>Repeat the ladyfinger and mascarpone layers, dust with
                        remaining cocoa powder, cover,
                        and chill for at least 4 hours before serving with
            ...
            <div id="wd-images">
                ...
                <br/>
                <img id="wd-teslabot" src="images/Optimus_Tesla.jpg"
                     height="200px"/>
            </div>
            ...
            <div id="wd-forms">
                ...
                <form id="wd-text-fields">
                    ...
                    <input type="password" id="wd-text-fields-password"
                           value="123@#$asd"/>
                    <br/>
                    <label htmlFor="wd-text-fields-first-name">First
                        name:</label>
                ...
                <input type="checkbox" name="check-genre"
                       id="wd-chkbox-comedy"/>
                ...
                <h5>Select one</h5>
                <label htmlFor="wd-select-one-genre"> Favorite movie
                    genre: </label><br/>
                ...
                <h5>Select many</h5>
                <label htmlFor="wd-select-many-genre"> Favorite movie
                    genres: </label><br/>
                ...
                Please <a id="wd-lipsum-banners" href="https://www.lipsum.com/banners/">click here </a>
                to get mock banners<br/>
